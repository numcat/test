...
class myDocumentGroundedDialogRerankPipeline(DocumentGroundedDialogRerankPipeline):
    ...
    def save(self, addr):
        file_out = open(addr, 'w', encoding='utf-8')
...
def main():
    ...
    file_in = open('./input.jsonl', 'r', encoding='utf-8')
    all_querys = []
    ...
    file_in = open('./DAMO_ConvAI/nlp_convai_retrieval_pretrain/evaluate_result.json', 'r', encoding='utf-8')
